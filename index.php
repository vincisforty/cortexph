...
<head>
    ...
    <title>Cortex Technologies Corp | Innovation & Technology</title>

    <!-- SEO Meta Tags -->
    <meta name="description" content="Cortex Technologies Corp - Innovations, Marketing, and Technology Solutions. Experts in WordPress and Shopify development. Building brands that win.">
    <meta name="keywords" content="Cortex, Cortex PH, Technology, Innovation, Marketing, E-commerce, Shopify, WordPress, Web Development, Digital Transformation, Philippines">
    <meta name="author" content="Cortex Technologies Corp">
        ...
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        cortex: {
                            primary: '#da8622',   // Ochre
                            secondary: '#a22446', // Mexican Red
                            accent: '#f4ce7b',    // Golden Sand
    ...
    <nav class="fixed top-0 w-full z-50 transition-all duration-300" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex flex-1 justify-end items-center space-x-10 mr-10">
                    <a href="#home" class="text-slate-100 hover:text-cortex-accent font-medium text-sm transition-colors">Home</a>
                    <a href="#about" class="text-slate-100 hover:text-cortex-accent font-medium text-sm transition-colors">About</a>
                    <a href="#portfolio-overview" class="text-slate-100 hover:text-cortex-accent font-medium text-sm transition-colors">Portfolio</a>
                    <a href="#news" class="text-slate-100 hover:text-cortex-accent font-medium text-sm transition-colors">News</a>
                    <a href="#contact" class="text-slate-100 hover:text-cortex-accent font-medium text-sm transition-colors">Contact</a>
                </div>

                <!-- CTA Button 
                <div class="hidden md:flex flex-shrink-0">
                    <a href="#contact" class="px-6 py-2.5 bg-cortex-primary text-slate-100 font-medium text-sm rounded-full hover:bg-cortex-secondary transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                        Connect with us
                    </a>
                </div> -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[300px]">
                ...
                <div class="lg:col-span-2 lg:row-span-2 relative group overflow-hidden rounded-3xl bg-slate-900 shadow-lg border border-slate-300 cursor-pointer hover:shadow-2xl hover:shadow-cortex-primary/20 transition-all duration-500" data-aos="fade-up">
                    <a href="#brand-sharkninja" class="absolute inset-0 z-10" aria-label="Go to product"></a>
                ...
                <!-- Large Card (Left) -->
                <div class="lg:col-span-2 lg:row-span-2 relative group overflow-hidden rounded-3xl bg-slate-900 shadow-lg border border-slate-300 cursor-pointer hover:shadow-2xl hover:shadow-cortex-primary/20 transition-all duration-500" data-aos="fade-up">
                    <a href="#brand-concepstore" class="absolute inset-0 z-10" aria-label="Go to product"></a>
    ...
    <section id="news" class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <p class="text-slate-600 text-lg">Celebrating our journey and the partnerships that drive us forward.</p>
            </div>

            <div class="grid md:grid-cols-3 gap-8">
                <!-- News Item 1 -->
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden group hover:shadow-2xl hover:-translate-y-2 transition-all duration-300" data-aos="fade-up" data-aos-delay="100">
                    <div class="h-48 bg-slate-200 relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Partnership" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-cortex-primary">Business & Growth</div>
                    </div>
                    <div class="p-8">
                        <div class="text-sm text-slate-500 mb-3">December 2025</div>
                        <h3 class="font-display text-xl font-bold text-slate-900 mb-3 group-hover:text-cortex-primary transition-colors">SharkNinja ramps up its presence with new retail pop-up stores in three premier Metro Manila malls</h3>
                        <p class="text-slate-600 mb-4">See it, feel it, love it, own it—visit SharkNinja’s Metro Manila pop-ups.  SharkNinja is continuously expanding, bringing products closer to customers.</p>
                        <!-- <a href="#" class="inline-flex items-center text-cortex-primary font-semibold hover:text-cortex-secondary transition-colors">Read More <i class="fas fa-arrow-right ml-2 text-xs"></i></a> -->
                    </div>
                </div>

                <!-- News Item 2 -->
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden group hover:shadow-2xl hover:-translate-y-2 transition-all duration-300" data-aos="fade-up" data-aos-delay="200">
                    <div class="h-48 bg-slate-200 relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Milestone" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-cortex-secondary">Retail Expansion</div>
                    </div>
                    <div class="p-8">
                        <div class="text-sm text-slate-500 mb-3">December 2025</div>
                        <h3 class="font-display text-xl font-bold text-slate-900 mb-3 group-hover:text-cortex-secondary transition-colors">MangKosme.com: Affordable, High-Quality, Always Discoverable</h3>
                        <p class="text-slate-600 mb-4">Shop. Share. Repeat.  One of Cortex’s fastest growing brands, MangKosme’s products are high-quality, affordable, and always trending—reaching millions online and available at its premium warehouse 7 days a week.</p>
                        <!-- <a href="#" class="inline-flex items-center text-cortex-secondary font-semibold hover:text-cortex-primary transition-colors">Read More <i class="fas fa-arrow-right ml-2 text-xs"></i></a> -->
                    </div>
                </div>

                <!-- News Item 3 -->
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden group hover:shadow-2xl hover:-translate-y-2 transition-all duration-300" data-aos="fade-up" data-aos-delay="300">
                    <div class="h-48 bg-slate-200 relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Expansion" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-cortex-primary">Customer Experience</div>
                    </div>
                    <div class="p-8">
                        <div class="text-sm text-slate-500 mb-3">December 2025</div>
                        <h3 class="font-display text-xl font-bold text-slate-900 mb-3 group-hover:text-cortex-primary transition-colors">ConcepStore: Effortless Lifestyle Shopping</h3>
                        <p class="text-slate-600 mb-4">With nearly 2,000 loyal customers and thousands more trying it every day, ConcepStore combines online convenience with a personal touch. The concierge service makes shopping effortless—helping you get exactly what you want, when you want it.</p>
                        <!-- <a href="#" class="inline-flex items-center text-cortex-primary font-semibold hover:text-cortex-secondary transition-colors">Read More <i class="fas fa-arrow-right ml-2 text-xs"></i></a> -->
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center md:items-start gap-12 mb-12">
                ...
                <div class="text-center md:text-right">
                    <ul class="flex flex-wrap justify-center md:justify-end gap-8">
                        ...
                        <li><a href="#about" class="hover:text-cortex-primary transition-colors">About Us</a></li>
                        <li><a href="#portfolio" class="hover:text-cortex-primary transition-colors">Portfolio</a></li>
                        <li><a href="#news" class="hover:text-cortex-primary transition-colors">News</a></li>
                        <li><a href="#contact" class="hover:text-cortex-primary transition-colors">Contact</a></li>
                    </ul>
                </div>
            </div>
            
            <div class="pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center text-sm">
                <p>&copy; 2026 Cortex Technologies Corp. All rights reserved.</p>
                        ...
                        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-2xl">
                            ...
                            <div class="relative mt-6 flex-1 px-4 sm:px-6">
                                <div class="flex flex-col space-y-6">
                                    <a href="#home" class="text-lg font-medium text-slate-900 hover:text-cortex-primary transition-colors mobile-link">Home</a>
                                    <a href="#about" class="text-lg font-medium text-slate-900 hover:text-cortex-primary transition-colors mobile-link">About</a>
                                    <a href="#portfolio-overview" class="text-lg font-medium text-slate-900 hover:text-cortex-primary transition-colors mobile-link">Portfolio</a>
                                    <a href="#news" class="text-lg font-medium text-slate-900 hover:text-cortex-primary transition-colors mobile-link">News</a>
                                </div>
                                
                                <div class="mt-10 pt-10 border-t border-slate-100">
                                    <a href="#contact" class="flex w-full items-center justify-center rounded-full bg-slate-900 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-slate-800 mobile-link">
                                        Connect with us
                                    </a>
